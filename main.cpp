//
// File:        meucubo.c
// Author:      Lucas Lagrimante e Leonardo Smoginski
// Created:     Dezembro 2017
...
//              Que o usuário pode rotacionar com as setas do teclado e apertando F1 o cubo se move
// 
...
void initTextures() {
    ...
    //cima
    texture[0] = SOIL_load_OGL_texture("./images/cima.png", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);

    //baixo
    texture[1] = SOIL_load_OGL_texture("./images/baixo.png", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);

    //frente
    texture[2] = SOIL_load_OGL_texture("./images/frente.png", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);

    //costa
    texture[3] = SOIL_load_OGL_texture("./images/costa.png", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);

    //direito
    texture[4] = SOIL_load_OGL_texture("./images/direito.png", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);

    //esquerdo
    texture[5] = SOIL_load_OGL_texture("./images/esquerdo.png", SOIL_LOAD_AUTO, SOIL_CREATE_NEW_ID, SOIL_FLAG_INVERT_Y);
}
// ----------------------------------------------------------
...
int main(int argc, char* argv[]) {
    ...
    glutCreateWindow("APERTE F1 - JORGINHO'S CUBE'S by Lucas Lagrimante and Leonardo Smoginski");
